...
interface LineChartSlideProps { title: string; data: number[]; labels?: string[]; color?: string }

export const LineChartSlide: React.FC<LineChartSlideProps> = ({ title, data, labels, color }) => {
  ...
  return (
    <AbsoluteFill style={{ justifyContent: "center", alignItems: "center", opacity: 1 }}>
      ...
      <div style={{ marginTop: 40 }}>
        <LineChart data={data} labels={labels} delay={6} width={1300} height={500} color={color} />
      </div>
    </AbsoluteFill>
  );
};
